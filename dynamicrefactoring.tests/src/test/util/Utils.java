...
import dynamicrefactoring.domain.metadata.classifications.xml.imp.PluginCatalogTest;
...
public class Utils {
	...
	public static void setTestRefactoringInRefactoringsDir() throws IOException {
		...
		FileManager.copyBundleDirToFileSystem(PluginCatalogTest.TEST_REPO_PATH,
		...
		FileUtils.copyDirectory(new File(RefactoringPlugin.getDefault()
				...
				+ File.separator + "test" + File.separator + PluginCatalogTest.TEST_REPO_PATH),
