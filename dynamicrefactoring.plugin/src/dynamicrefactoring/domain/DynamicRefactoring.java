...
public class DynamicRefactoring extends MOONRefactoring {
	 ...
	 * Constructor.
	 * 
	 * @param refactoringFilePath ruta del fichero con la refactorizaci�n.
	 * @param model modelo MOON sobre el que se refactoriza.
	 * @param parameters tabla de par�metros de entrada de la refactorizaci�n.
	 * 
	 * @throws RefactoringException si se produce un error al construir
	 * la refactorizaci�n din�mica.
	 */
	 ...
	 * alguno de los componentes de la refactorizaci�n. 
	 */
	 ...
	 * 
	 * @param name nombre simple de la precondici�n.
	 * 
	 * @throws RefactoringException si se produce un error al crear la
	 * precondici�n o al a�adirla a la refactorizaci�n. 
	 */
	 ...
	 * 
	 * @param name nombre simple de la acci�n.
	 * 
	 * @throws RefactoringException si se produce un error al crear la
	 * acci�n concreta o al a�ad�rsela a la refactorizaci�n. 
	 */
	 ...
	 * 
	 * @param name nombre simple de la postcondici�n.
	 * 
	 * @throws RefactoringException si se produce un error al crear la
	 * postcondici�n concreta o al a�ad�rsela a la refactorizaci�n. 
	 */
	 ...
	 * como par�metro.
	 * 
	 * @param constructor constructor cuya lista de par�metros necesarios se 
	 * desea obtener.
	 ...
	 * constructor.
	 * 
	 * @throws RefactoringException si se produce alg�n error durante la
	 * construcci�n de la lista de par�metros del constructor. 
	 */
	...
	/**
	 * Obtiene el nombre de un predicado o acci�n a partir de su constructor.
	 * 
	 ...
	 * primer componente es el tipo, y el segundo el nombre del par�metro.</p>
	 * 
	 * @param refactoringFilePath ruta del fichero XML con la refactorizaci�n.
	 * 
	 ...
	 * la definici�n de los par�metros de entrada. 
	 */
	 ...
	 * 
	 * @param elementName nombre simple del predicado o acci�n.
	 * @param position posici�n de la entrada en la lista de par�metros.
	 * @param type c�digo del tipo de elemento 
	 * ({@link RefactoringConstants#PRECONDITION}, 
	 * {@link RefactoringConstants#POSTCONDITION} o
	 * {@link RefactoringConstants#ACTION}).
	 * 
