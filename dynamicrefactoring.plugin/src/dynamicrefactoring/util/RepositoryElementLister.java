...
public class RepositoryElementLister {
	...
	private RepositoryElementLister() {
		sourcePreconditionDir = RefactoringConstants.PRECONDITION_DIR;
		sourcePostconditionDir = RefactoringConstants.POSTCONDITION_DIR;
		sourceActionDir = RefactoringConstants.ACTION_DIR;
		sourceJavaActionDir = RefactoringConstants.JAVA_ACTION_DIR;
		sourceJavaPredicateDir = RefactoringConstants.JAVA_PREDICATE_DIR;
	 ...
	 * 
	 * @return una tabla de pares en la que se usa como �ndice el nombre
	 ...
	 * 
	 * @return una tabla asociativa con pares <nombre, fichero> para cada una de
	 *         las acciones independientes del lenguaje encontradas.
	 * 
	 * @throws IOException
	 *             si se el directorio de acciones por defecto no existe o no se
	 *             consigue acceder a �l.
	 */
	public HashMap<String, String> getIndependentActionList()
			throws IOException {
	 ...
	 * encontradas en el directorio por defecto de precondiciones del
	 * repositorio.
	 * 
	 * @return una tabla asociativa con pares <nombre, fichero> para cada una de
	 *         las precondiciones independientes del lenguaje encontradas.
	 * 
	 * @throws IOException
	 *             si se el directorio de precondiciones por defecto no existe o
	 *             no se consigue acceder a �l.
	 */
	public HashMap<String, String> getIndependentPreconditionList()
			throws IOException {
	 ...
	 * encontradas en el directorio por defecto de postcondiciones del
	 * repositorio.
	 * 
	 * @return una tabla asociativa con pares <nombre, fichero> para cada una de
	 *         las postcondiciones independientes del lenguaje encontradas.
	 * 
	 * @throws IOException
	 *             si se el directorio de postcondiciones por defecto no existe
	 *             o no se consigue acceder a �l.
	 */
	public HashMap<String, String> getIndependentPostconditionList()
			throws IOException {
		return getElementList(sourcePostconditionDir);
	}

	/**
	 * Obtiene el conjunto de acciones dependientes del lenguaje Java
	 * encontradas en el directorio por defecto de las acciones del repositorio
	 * dependientes de Java.
	 * 
	 * @return una tabla asociativa con pares <nombre, fichero> para cada una de
	 *         las acciones dependientes de Java encontradas.
	 * 
	 * @throws IOException
	 *             si se el directorio de acciones para Java por defecto no
	 *             existe o no se consigue acceder a �l.
	 */
	...
	/**
	 * Obtiene el conjunto de predicados dependientes del lenguaje Java
	 * encontrados en el directorio por defecto de los predicados del
	 * repositorio dependientes de Java.
	 * 
	 * @return una tabla asociativa con pares <nombre, fichero> para cada uno de
	 *         los predicados dependientes de Java encontrados.
	 * 
	 * @throws IOException
	 *             si se el directorio de predicados para Java por defecto no
	 *             existe o no se consigue acceder a �l.
	 */
	 ...
	 * por defecto de acciones del repositorio, dependientes o independientes
	 * del lenguaje.
	 * 
	 * @return el conjunto de todas las acciones encontradas en los directorios
	 *         por defecto de acciones del repositorio, dependientes o
	 ...
	 *             acciones.
	 */
	public HashMap<String, String> getAllActionsList() {
		try {
	...
	/**
	 * Obtiene el conjunto de todos los predicados encontrados en los
	 * directorios por defecto de predicados del repositorio, dependientes o
	 * independientes del lenguaje.
	 * 
