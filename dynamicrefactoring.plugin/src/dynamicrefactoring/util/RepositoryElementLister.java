...
public class RepositoryElementLister {
	 ...
	 * 
	 * @return una tabla en la que se usa como �ndice el nombre comprensible 
	 ...
	 * 
	 * @param sourceDir ruta del directorio en que se buscar�n los elementos
	 * del repositorio.
	 * 
	 * @return una tabla en la que se usa como �ndice el nombre comprensible 
     ...
     * no existe o no se consigue acceder a �l.
     */
	 ...
	 * 
	 * @param dir el directorio ra�z desde donde se comienza el listado.
