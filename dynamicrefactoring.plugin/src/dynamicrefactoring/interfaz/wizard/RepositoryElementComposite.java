		...
		public void widgetSelected(SelectionEvent e) {
			...
			if(title.equals(RefactoringWizardPage3.PRECONDITIONS_TITLE)){
				refactorings=new ArrayList<DynamicRefactoringDefinition>(
						PluginClassificationsCatalog.getInstance().getRefactoringsContainsPrecondition(notQualifiedName));
			}else{
				if(title.equals(RefactoringWizardPage4.ACTIONS_TITLE)){
					refactorings=new ArrayList<DynamicRefactoringDefinition>(
							PluginClassificationsCatalog.getInstance().getRefactoringsContainsAction(notQualifiedName));
				}else{ //title.equals(RefactoringWizardPage5.POSTCONDITIONS_TITLE)
					refactorings=new ArrayList<DynamicRefactoringDefinition>(
							PluginClassificationsCatalog.getInstance().getRefactoringsContainsPostcondition(notQualifiedName));
				}
			}
