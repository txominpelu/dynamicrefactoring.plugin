 ...
 * 
 * <p>Permite asociar hasta un m�ximo de dos ejemplos concretos a la 
 * refactorizaci�n. Cada uno de los ejemplos vendr� definido por un fichero
 * con el estado del sistema antes de la refactorizaci�n, y otro con su 
...
public class RefactoringWizardPage6 extends WizardPage {
	 ...
	 * antes de la refactorizaci�n, y otra con la ruta del fichero que contiene
	 * el estado del ejemplo despu�s de la refactorizaci�n.
	 */
	...
	/**
	 * Se asegura de que ambos ejemplos est�n completos o vac�os, es decir, no se
	 * admite la asociaci�n de solo uno de los dos ficheros que componen el ejemplo.
	 */
	...
	/**
	 * Comprueba si un campo de texto no vac�o contiene una cadena terminada en la
	 * extensi�n <i>.txt</i> o <i>.java</i>.
	 * 
	 * @param field campo de texto cuyo contenido se debe verificar.
	 * 
	 * @return <code>true</code> si el campo de texto no est� vac�o y su contenido
	 * no termina en la extensi�n <i>.txt</i> ni <i>.java</i>, o est� vac�o. 
	...
	/**
	 * Implementa el proceso de elecci�n de uno de los ficheros de texto o Java con 
	...
	private class ExampleChooserAction implements SelectionListener {
		 ...
		 * Constructor.<p>
		 * 
		 * @param textField campo de texto en que se guardar� la ruta del 
		 ...
		 * ficheros de texto con extensi�n <i>.txt</i>.</p>
		 * 
