 ...
 * un nombre, determinar a partir de qu� otra entrada y mediante la llamada
 * a qu� m�todo se puede obtener su valor, as� como establecer cu�l de todas
 * constituir� la entrada principal a la refactorizaci�n.</p>
 * 
...
public class RefactoringWizardPage2 extends WizardPage {
	...
	/**
	 * Bot�n que permite desplazar una entrada de la refactorizaci�n hacia abajo.
	 */
	...
	/**
	 * Lista desplegable con los identificadores de par�metros disponibles ya 
	 ...
	 * y como valor, el n�mero de entradas que tienen el tipo seleccionado, menos 1.
	 * </p>
	 */
	 ...
	 *  
	 * <p>Se utiliza como clave el nombre completamente cualificado del tipo
	 * de cada entrada concatenado con un espacio en blanco y el n�mero de entrada
	 * que utiliza ese tipo, y como valor, un objeto de tipo <code>InputParameter
	 * </code> con toda la informaci�n asociada a la entrada.</p>
	 */
	 ...
	 * la lista de tipos con el fin de ayudar al usuario a la compresi�n de la interfaz.
	 */
	 ...
	 * Constructor.
	 * 
	 * @param refactoring refactorizaci�n que se est� editando o <code>null
	 ...
	 * <ol>El nombre simple del m�tod mediante el cual se obtendr�an dichos valores
	...
	private void fillInRefactoringData(){
		if (refactoring.getInputs() != null)
			for (String[] nextInput : refactoring.getInputs()){
				...
				// Si el tipo no est� en la lista de tipos disponibles, se a�ade.
	...
	/**
	 * A�ade tantas entradas a la lista de entradas elegidas como tipos se encuentren
	 * seleccionados en la lista de tipos disponibles en el modelo.
	 * 
	 * <p>Para cada entrada a�adida, le asocia un n�mero, que ser� el n�mero de 
	 ...
	 * 
	 * <p>Solo se tienen en cuenta los tipos de representaci�n de los paquetes
	 * <code>moon.core.classdef</code>, <code>moon.core.genericity</code> y
	 * algunos otros.</p>
	 * 
	 * @param patron Expresion regular de b�squeda.
	 */
	private void fillSearchTypesList(String patron){
		...
		try{
			...
			for(int i=0; i < itemList.length; i++){
				...
				//En caso de que el tipo coincida con el patr�n de b�squeda lo a�adimos a la lista.
	 ...
	 * 
	 * @param fromName nombre de la entrada a partir de la cual se obtendr�a 
	 * el valor de esta entrada mediante la aplicaci�n del m�todo seleccionado.
	 * @param returnType tipo del resultado que deben devolver los m�todos en caso de que
	 * devuelvan un valor �nico en lugar de un conjunto.
	 */
	...
	/**
	 * Obtiene los nombres de los m�todos de una clase que devuelven objetos
	 ...
	 * 
	 * @param className nombre de la clase cuyos m�todos se deben obtener.
	 * @param type tipo del valor �nico que pueden devolver los m�todos.
	 * 
	...
	private class TypeSelectionListener implements SelectionListener {
		 ...
		 * 
		 * <p>Activa el bot�n que permite a�adir el o los tipos seleccionados
		...
		public void widgetSelected(SelectionEvent e) {
			...
			ArrayList<DynamicRefactoringDefinition> refactoringsInputType=
				new ArrayList<DynamicRefactoringDefinition>(
						PluginCatalog.getInstance().getRefactoringsContainsInputType(typeSelected));
			...
			ArrayList<DynamicRefactoringDefinition> refactoringsRootInputType=
				new ArrayList<DynamicRefactoringDefinition>(
						PluginCatalog.getInstance().getRefactoringsContainsRootInputType(typeSelected));
	...
	private class NameFocusListener implements FocusListener {
		 ...
		 * par�metro seleccionado).
		 *
		 * @param e evento con la informaci�n referente a la recepci�n del foco.
		 * 
		 ...
		 * el foco.
		 * 
		 * @param e evento con la informaci�n referente a la p�rdida del foco.
		 * 
		 ...
		 * @param current el �nico par�metro de entrada para el que se admite el
		 * nombre como v�lido.
		 * 
	 ...
	 * del par�metro al objeto a partir del que se puede obtener su valor.</p>
	 * 
	 * @author <A HREF="mailto:sfd0009@alu.ubu.es">Sonia Fuente de la Fuente</A>
	 * @author <A HREF="mailto:ehp0001@alu.ubu.es">Enrique Herrero Paredes</A>
	 */
	private class FromFocusListener implements FocusListener {
		...
		/**
		 * Recibe una notificaci�n indicando que el elemento observado ha recibido
		...
		/**
		 * Recibe una notificaci�n indicando que el elemento observado ha perdido
		 * el foco.
		 * 
		 * @param e evento con la informaci�n referente a la p�rdida del foco.
		 * 
	...
	/**
	 * Permite observar y controlar los cambios realizados sobre el contenido 
	 * del campo desplegable que contiene el m�todo mediante el que se 
	 * puede obtener a su vez el valor de la entrada actual.
	 * 
	 * <p>Cuando se modifica el contenido de dicho campo, se actualiza el apuntador
	 * del par�metro al m�todo mediante el que se puede obtener su valor.</p>
	 * 
	 * @author <A HREF="mailto:sfd0009@alu.ubu.es">Sonia Fuente de la Fuente</A>
	 * @author <A HREF="mailto:ehp0001@alu.ubu.es">Enrique Herrero Paredes</A>
	 */
	private class MethodFocusListener implements FocusListener {
		...
		/**
		 * Recibe una notificaci�n indicando que el elemento observado ha recibido
		 * el foco (en este caso, el desplegable que contiene los m�todos de la
