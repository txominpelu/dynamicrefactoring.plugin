 ...
 */ 
public class RenameClassType extends Action {
	 ...
	 *
	 * @param classDef la clase el nombre de cuyo tipo se desea cambiar.
	 * @param newName el nuevo nombre de la clase.
	 */	
	public RenameClassType(ClassDef classDef, Name newName){
		
		super();
		
		this.classType = classDef.getClassType();
