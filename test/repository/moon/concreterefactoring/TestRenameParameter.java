...
public class TestRenameParameter extends RefactoringTemplateAbstractTest {
	 ...
	 *
	 * <p>Se toma un método sencillo de una clase, con un único argumento formal
	 * en su lista de parámetros y sin variables locales, y se le asigna un 
	 * nombre correcto, distinto al de cualquier atributo de la clase.</p>
	 * 
	...
	public void testSimple() throws Exception{
		...
		assertEquals("Test renombrar argumento simple: " + //$NON-NLS-1$
			...
			factory.createName("paqueteA.ClaseA~metodo1%int#nuevoArgumento"), //$NON-NLS-1$
	 ...
	 *
	 * <p>Se toma en una clase sin atributos un método que tiene variables
	 * locales y varios argumentos formales, y se intenta renombrar el
	 * argumento que ocupa la posición central en la lista de parámetros, 
	 * dándole un nombre distinto al de cualquiera de las variables locales o
	 * de los demás argumentos.</p>
	 * 
	 * @throws Exception si se produce un error durante la ejecución de la prueba.
	 */ 
	@Test
	 ...
	 *
	 * <p>Comprueba que se lanza la excepción cuando se intenta renombrar un 
	 * argumento formal para darle un nombre que ya está asignado a otro 
	 * parámetro del método.</p>
	 *
	 * <p>En un método con dos argumentos formales, intenta asignarle al primero el
	 * mismo nombre que ya tiene el segundo.</p>
	 * 
	 * @throws Exception si se produce un error durante la ejecución de la prueba.
	 */
	 ...
	 * local del método.</p>
	 *
	 * <p>En un método con un argumento formal y una variable local, intenta 
	 * asignarle al primero el mismo nombre que ya tiene la variable local.</p>
	 * 
	 * @throws Exception si se produce un error durante la ejecución de la prueba.
	 */
	@Test(expected=PreconditionException.class) 
	 ...
	 * <p>Se toma un método sencillo de una clase, con un único argumento formal
	 * en su lista de parámetros y sin variables locales, y se le asigna un 
	 * nombre correcto, distinto al de cualquier atributo de la clase. Después,
	 * se deshace el renombrado.</p>
	 * 
	 * @throws Exception si se produce un error durante la ejecución de la prueba.
	 */   
	@Test
	public void testUndoSimple() throws Exception{
		...
		assertEquals("Test deshacer renombrado de parámetro simple: " + //$NON-NLS-1$
			"no se ha restaurado correctamente el nombre del argumento formal.", //$NON-NLS-1$
			"paqueteA.ClaseA~metodo1%int#p1", argumento2.getUniqueName().toString()); //$NON-NLS-1$
	}
}